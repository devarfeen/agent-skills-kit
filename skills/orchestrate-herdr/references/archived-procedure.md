# Orchestrate herdr — archived procedure

Body of the deprecated `/orchestrate-herdr` skill, moved here unchanged (deprecated 2026-07-23; the notice and confirmation gate live in `SKILL.md`). Load only after the user has confirmed running the deprecated skill, then follow this as the skill body.
