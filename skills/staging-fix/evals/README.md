...
This skill owns its evals. Everything needed to judge `/staging-fix` is in this folder.
...
| [`baseline.md`](baseline.md) | First scorecard for this skill (new in the 2026-07 batch) |
