...
- **Retrieval order.** `CONTEXT.md` + `specs/adr/` are binding (read before deciding) > the current spec, sub-issues, and code > native CLI memory. Binding sources override informal usage.
