...
```markdown
<!-- Generated by the agents-md skill · v3 · re-run /agents-md to regenerate -->
# Agent Instructions
...
The skill version is `v3`. Both generated files carry the marker `<!-- Generated by the agents-md skill · v3 · re-run /agents-md to regenerate -->` as their first line (shown in the templates above). Bump the version here and in both templates whenever these rules change.
